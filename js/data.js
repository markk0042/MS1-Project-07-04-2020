...
const MAPS = [
  {
    ...
    size: 48,
    tile: 40,
    palette: { grass: "#5cb85c", road: "#4a5562", building: "#e8eef5", accent: "#e74c3c" },
    hospital: { x: 8, y: 8 },
    station: { x: 10, y: 36 },
  ...
  },
  {
    ...
    size: 44,
    tile: 40,
    palette: { grass: "#62c062", road: "#4a5562", building: "#f2d6c2", accent: "#27ae60" },
    hospital: { x: 34, y: 10 },
    station: { x: 6, y: 34 },
    layout: null,
  },
  {
    ...
    size: 46,
    tile: 40,
    palette: { grass: "#58b358", road: "#4a5562", building: "#d4e4f7", accent: "#e67e22" },
    hospital: { x: 22, y: 6 },
    station: { x: 38, y: 38 },
    layout: null,
  },
  {
    ...
    size: 42,
    tile: 40,
    palette: { grass: "#5cb85c", road: "#4a5562", building: "#cfe8d8", accent: "#2980b9" },
    hospital: { x: 6, y: 20 },
    station: { x: 34, y: 34 },
    layout: null,
  },
  {
    ...
    size: 40,
    tile: 40,
    palette: { grass: "#62c062", road: "#4a5562", building: "#f0cfcf", accent: "#c0392b" },
    hospital: { x: 18, y: 8 },
    station: { x: 8, y: 30 },
    layout: null,
  },
  {
    ...
    size: 44,
    tile: 40,
    palette: { grass: "#58b358", road: "#4a5562", building: "#e6d5f0", accent: "#8e44ad" },
    hospital: { x: 30, y: 30 },
    station: { x: 8, y: 8 },
    layout: null,
  },
